...
public class Test {
	...
	public Test(final String db_file_name_prefix) throws Exception { // note more
		// general
		// exception
	...
	public synchronized void query(final String expression) throws SQLException {
	...
	public synchronized void update(final String expression) throws SQLException {
