...
/**
 * ParsedMultiVarFunction defines a function of multiple variables using a
 * String.
 * 
...
public final class ParsedMultiVarFunction implements MultiVarFunction {
	 ...
	 */
	public ParsedMultiVarFunction(final String _fStr, final String[] var) throws Exception {
		fStr = _fStr;
