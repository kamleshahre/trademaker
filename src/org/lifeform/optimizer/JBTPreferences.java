...
public enum JBTPreferences {
	// TWS connection
	Host("Host", "localhost"), Port("Port", "7496"), ClientID("Client ID", "0"),
	...
	// Back tester
	BackTesterFileName("backTester.dataFileName", ""), BackTesterUseDateRange(
			"backTester.useDateRange", "false"), BackTesterTestingPeriodStart(
			"backTester.testingPeriodStart", ""), BackTesterTestingPeriodEnd(
			"backTester.testingPeriodEnd", ""),

	// Optimizer
	OptimizerMinTrades("optimizer.minTrades", "50"), OptimizerSelectBy(
			"optimizer.selectBy", ""), OptimizerMethod("optimizer.method", ""), OptimizerWindowWidth(
